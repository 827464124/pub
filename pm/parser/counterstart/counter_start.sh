...
SPOOL_DIR=/home/nuoen/spool
PM_DIR=/home/nuoen/ioss/pm
LOG_DIR=/home/nuoen/log

PARSER_HOME=${PM_DIR}/parser

AUDIT_FILE=${LOG_DIR}/counter_parse.audit
LOG_FILE=${LOG_DIR}/counter_parse.log
LOG_LEVEL=1
...
OUT_DIR=${DATA_DIR}/counterload

INPUT_STORAGE_DIR=${DATA_DIR}/archive
INTERMEDIATE_STORAGE_DIR=
OUTPUT_STORAGE_DIR=
